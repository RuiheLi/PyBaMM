...
########################     Global settings!!!
On_HPC = False
purpose = "Case142_Eact_SEI"
para_csv = f'{purpose}.csv'   # name of the random file to get parameters
...
pool_no = int(Scan_end-Scan_start+1)
...
head_pre = [
    ...
    "Error LAM NE %","Error LAM PE %","Error Res %","Punish",
    "Dry out",]
